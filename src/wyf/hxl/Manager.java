    ...
    public void table(){
    	try{
			 ...
			 while(db.rs.next()){
			 	k++;
		       	Vector<String> v = new Vector<String>();
				for(int i=1;i<=3;i++){//顺序找到所搜到的结果中的各项记录
