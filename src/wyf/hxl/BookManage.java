...
public class BookManage extends JPanel implements ActionListener
{
	...
	public void deleteBook(){
		...
		db=new DataBase();
		db.selectDb(sql);//删除图书记录
		try{
			if(db.rs.next()){//若Record表中有该书号，则输出提示对话框
				JOptionPane.showMessageDialog(this,	"不能删除此书",
							        "消息",JOptionPane.INFORMATION_MESSAGE);
				return;	
			}
		}
	...
	public void updateBook(){
		...
		if(bookno.equals("")){//当书号输入为空时，进行提示
			...
			switch(i){//请详细解读switch语句
		        ...
		        flag=db.updateDb(sql);//更新书名、作者信息
		        if(flag>0){
					JOptionPane.showMessageDialog(this,"恭喜你，修改成功!!!",
					                        "消息",JOptionPane.INFORMATION_MESSAGE);		        	
		        }break;
		        ...
		        flag=db.updateDb(sql);//更新书名、出版社信息
		        if(flag>0){
					JOptionPane.showMessageDialog(this,"恭喜你，修改成功!!!",
					                     "消息",JOptionPane.INFORMATION_MESSAGE);		        	
		        }break;
		        ...
		        sql="update BOOK set Author='"+str1[2]+"',"+"Publishment='"
		                      +str1[3]+"' where BookNO="+b;
		        flag=db.updateDb(sql);//更新作者、出版社信息
		        if(flag>0){
					JOptionPane.showMessageDialog(this,"恭喜你，修改成功!!!",
					                       "消息",JOptionPane.INFORMATION_MESSAGE);		        	
		        }break;
		        ...
		        flag=db.updateDb(sql);//更新书名、作者、出版社信息
		        if(flag>0){
					JOptionPane.showMessageDialog(this,"恭喜你，修改成功!!!",
					                      "消息",JOptionPane.INFORMATION_MESSAGE);		        	
		        }break;
		        ...
		        flag=db.updateDb(sql);//更新书名和购进时间信息
		        if(flag>0){
					JOptionPane.showMessageDialog(this,"恭喜你，修改成功!!!",
					                     "消息",JOptionPane.INFORMATION_MESSAGE);		        	
		        }break;
		        ...
		        sql="update BOOK set Author='"+str1[2]+"',"+"BuyTime='"
		                  +str1[4]+"' where BookNO="+b;
		        flag=db.updateDb(sql);//更新作者和购进时间信息
		        if(flag>0){
					JOptionPane.showMessageDialog(this,"恭喜你，修改成功!!!",
					                      "消息",JOptionPane.INFORMATION_MESSAGE);		        	
		        }break;
		        ...
		        flag=db.updateDb(sql);//更新书名、作者和购进时间信息
		        if(flag>0){
					JOptionPane.showMessageDialog(this,"恭喜你，修改成功!!!",
					                        "消息",JOptionPane.INFORMATION_MESSAGE);		        	
		        }break;
		        ...
		        sql="update BOOK set Publishment='"+str1[3]+"',"+"BuyTime='"
		                        +str1[4]+"' where BookNO="+b;
		        flag=db.updateDb(sql);//更新出版社和购进时间信息
		        if(flag>0){
					JOptionPane.showMessageDialog(this,"恭喜你，修改成功!!!",
					                       "消息",JOptionPane.INFORMATION_MESSAGE);		        	
		        }break;
		        ...
		        sql="update BOOK set BookName='"+str1[1]+"',"+"Publishment='"+str1[3]
		                       +"',"+"BuyTime='"+str1[4]+"' where BookNO="+b;
		        flag=db.updateDb(sql);//更新书名、出版社和购进时间信息
		        if(flag>0){
					JOptionPane.showMessageDialog(this,"恭喜你，修改成功!!!",
					                      "消息",JOptionPane.INFORMATION_MESSAGE);		        	
		        }break;
		        ...
		        sql="update BOOK set Author='"+str1[1]+"',"+"Publishment='"+str1[2]
		                        +"',"+"BuyTime='"+str1[4]+"' where BookNO="+b;
		        flag=db.updateDb(sql);//更新作者、出版社和购进时间信息
		        if(flag>0){
					JOptionPane.showMessageDialog(this,"恭喜你，修改成功!!!",
					                       "消息",JOptionPane.INFORMATION_MESSAGE);		        	
		        }break;
		        ...
		        flag=db.updateDb(sql);//更新书名、作者、出版社和购进时间信息
		        if(flag>0){
					JOptionPane.showMessageDialog(this,"恭喜你，修改成功!!!",
					                              "消息",JOptionPane.INFORMATION_MESSAGE);		        	
		        }break;
